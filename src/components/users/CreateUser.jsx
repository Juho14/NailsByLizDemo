...
const CreateUser = () => {
    ...
    return (
        <Box>
            ...
            <Typography style={{ marginLeft: 20, marginBottom: 20 }}>Lisää uusi käyttäjä </Typography>
            <Box component='form' onSubmit={handleSubmit} sx={{ margin: 2 }}>
                ...
                <Select
                    ...
                    onChange={handleChange}
                >
                    <MenuItem value="ROLE_USER">Asiakas</MenuItem>
                    <MenuItem value="ROLE_ADMIN">Työntekijä</MenuItem>
                </Select>
                <TextField
                    style={{ marginRight: 6, marginBottom: 6 }}
                    required
